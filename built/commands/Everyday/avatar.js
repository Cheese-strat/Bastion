    ...
    execute: function (msg, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ez.getmember(args.join(" "), msg.guild.members)];
                    case 1:
                        member = _a.sent();
                        if (!member && !args.length)
                            member = msg.member;
                        if (!member)
                            return [2 /*return*/, msg.channel.send("I couldn't find that target")];
                        embed = ez.embed(member.displayHexColor, member.user.username + "'s avatar:");
