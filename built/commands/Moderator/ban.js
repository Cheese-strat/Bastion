...
module.exports = {
    ...
    execute: function (msg, args, pokemon, data, client) {
        if (!msg.channel.memberPermissions(msg.author).has('BAN_MEMBERS'))
            return msg.channel.send("you dont have permission to do that");
        if (msg.channel.memberPermissions(client.user).has('BAN_MEMBERS'))
            return msg.channel.send("Insufficient permissions, please contact an administrator");
